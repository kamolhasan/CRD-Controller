...
type FakeFoos struct {
	Fake *FakeCrdcontrollerV1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "crdcontroller.com", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "crdcontroller.com", Version: "v1alpha1", Kind: "Foo"}
