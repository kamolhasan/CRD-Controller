...
import (
	...
	crdcontrollercomv1alpha1 "github.com/kamolhasan/CRD-Controller/pkg/apis/crdcontroller.com/v1alpha1"
	versioned "github.com/kamolhasan/CRD-Controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kamolhasan/CRD-Controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kamolhasan/CRD-Controller/pkg/client/listers/crdcontroller.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdcontrollerV1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdcontrollerV1alpha1().Foos(namespace).Watch(options)
			},
		},
		&crdcontrollercomv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdcontrollercomv1alpha1.Foo{}, f.defaultInformer)
}
